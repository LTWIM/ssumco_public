  ...
  const card = (info) => {
    const checklist = (list) => {
      return(
        <div className={styles.PriceCardBanner__checklist}>
          ...
          <div className={styles.PriceCardBanner__list}>
            {list}
          </div>
        </div>
      )
    ...
    return(
      <div className={styles.PriceCardBanner__card}>
        <div className={styles.PriceCardBanner__card__tier}>
          {info.tier}
        </div>
        <div className={styles.PriceCardBanner__card__dashSmall}/>
        <div className={styles.PriceCardBanner__card__price}>
          {info.price}$
        </div>
        <div className={styles.PriceCardBanner__card__per}>
          per month
        </div>
        ...
        <div className={styles.PriceCardBanner__subscribe}>
          Subscribe
        </div>
      </div>
    )
